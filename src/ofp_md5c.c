...
MD5Pad (MD5_CTX *context)
{
    ...
    ofp_MD5Update (context, PADDING, padLen);

    /* Append length (before padding) */
    ofp_MD5Update (context, bits, 8);
}
...
void
ofp_MD5Final (unsigned char digest[16],
      MD5_CTX *context)
{
    /* Do padding. */
    MD5Pad (context);
